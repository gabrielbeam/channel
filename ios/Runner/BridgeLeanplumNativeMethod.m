...
#import "BridgeLeanplumNativeMethod.h"
...
void BridgeLeanplumNativeMethodSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<BridgeLeanplumNativeMethod> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.channel.BridgeLeanplumNativeMethod.init"
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.channel.BridgeLeanplumNativeMethod.setUserAttributes"
        binaryMessenger:binaryMessenger
        codec:BridgeLeanplumNativeMethodGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.channel.BridgeLeanplumNativeMethod.track"
        binaryMessenger:binaryMessenger
        codec:BridgeLeanplumNativeMethodGetCodec()];
    if (api) {
